...
const intereses = ref([
    'Desarrollo Frontend: Soy desarrolladora frontend especializada en JavaScript, React y Bootstrap. Me enfoco en crear interfaces de usuario funcionales y atractivas.',
    'Diseño Colaborativo: Uso Figma para trabajar de la mano con el equipo de diseño, asegurando que el paso del diseño al desarrollo sea fluido.',
    'Innovación: Me interesa mantenerme actualizada con las últimas tendencias en tecnología para mejorar la experiencia del usuario en cada proyecto.',
]);
</script>
