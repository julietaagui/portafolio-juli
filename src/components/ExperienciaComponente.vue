<script setup>
import icono1 from './icons/gym.png';
import icono2 from './icons/pasantia.png';
import icono3 from './icons/proyecto.png';

import { ref } from 'vue';
const titulo = 'Desarrolladora Front-End';
const fecha = 'Desde Enero 2022 / Noviembre 2024';
const experiencias = ref([
    { id: 1, src: icono1, parrafo: 'Proyecto personal sobre una aplicacion web y una pagina web para un gimnasio. Mi roll es el de diseñadora UX/UI y desarrolladora frontend' },
    { id: 2, src: icono2, parrafo: 'Experiencia en una pasantia en una organizacion llamada No Country. Mi puesto fue de diseñadora UX/UI y de desarrolladora frontend. Las tecnologias implementadas fueron Figma para el diseño y JS, React y Bootstrap para el desarrollo.' },
    { id: 3, src: icono3, parrafo: 'Desarrollo de una web para comprar cursos. Este curso incluye las siguientes tecnologias: JavaScript, html y css.' },
]);
</script>
