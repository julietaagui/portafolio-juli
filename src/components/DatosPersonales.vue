...
const title = 'Julieta Aguilera';
const descripcion = 'Técnica Universitaria en Programación - UTN';
const residencia = 'San Rafael, Mendoza, Argentina';
const presentacion = 'Hola, Bienvenido a mi portafolio de proyectos. Soy un desarrolladora web con experiencia en el desarrollo de aplicaciones web, especificamente en el area de Front-end.';
const redesSociales = [
  { id: 1, name: 'linkedin', src: linkedin, url: 'https://www.linkedin.com/in/julieta-aguilera-947231321/' },
  { id: 2, name: 'Instagram', src: instagram, url: 'https://www.instagram.com/aguilerajulieta700/profilecard/?igsh=cDJnYnN3dWI0Mmc0' },
  { id: 3, name: 'github', src: github, url: 'https://github.com/julietaagui' },
  { id: 4, name: 'curriculum', src: cv, url: '' },
];
const telefono = '+54 9 2604-341029';
</script>
